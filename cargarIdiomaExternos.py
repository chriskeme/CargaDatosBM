...
path = "listado_ext.csv"
#path = "prueba.csv"
logTxt = open("log.txt", "w")
logTxt.write("")
logTxt.close()
logTxt = open("log.txt", "a")
token = 'eyJhbGciOiJIUzUxMiJ9.eyJidXNpbmVzc0lkIjoiUGVvcGxlQ2hhdEVTIiwibmFtZSI6IkNocmlzdGlhbiBIZXJuYW4gU2NoZXR0aW5vIiwiYXBpIjp0cnVlLCJpZCI6InpuR1pwbVBCbDhSS1RlZ2NuQ2JrcVNJb2xHOTIiLCJleHAiOjE3NTUxMDc0OTUsImp0aSI6InpuR1pwbVBCbDhSS1RlZ2NuQ2JrcVNJb2xHOTIifQ.93nsh2cSnR-5wyPNKl1lnQw5rJ1vJCfWloT-Rzpg50T9dJQHyzh61ikwxFCq3hACzhbDX04CBOVShNxQOPBfXg'
...
def recorroEmails():
    ...
    try:
        for email in datos:
           if '@mercadolivre' in email['email']:
               result = actUserPT(email['email'])#Descomentar
